...
| Finance API Backend Unit | 435 | Every PR | ~1min | `apps/finance-api-tests/FinanceApi.UnitTests/` |
| Finance API Integration | 120 | Every PR | ~3s | `apps/finance-api-tests/FinanceApi.IntegrationTests/` |
