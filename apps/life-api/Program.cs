...
using LifeApi.Features.Common.PasswordReset.Services;
using LifeApi.Features.Common.EmailVerification.Services;
...
builder.Services.AddSingleton<LifeApi.Features.Admin.Services.LogReaderService>();
