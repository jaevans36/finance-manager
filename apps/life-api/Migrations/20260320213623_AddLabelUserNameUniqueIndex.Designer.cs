...
namespace LifeApi.Migrations
{
    ...
    [Migration("20260320213623_AddLabelUserNameUniqueIndex")]
    partial class AddLabelUserNameUniqueIndex
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FinanceApi.Features.Labels.Models.Label", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("FinanceApi.Features.Labels.Models.TaskLabel", b =>
                {
            ...
            modelBuilder.Entity("FinanceApi.Features.Labels.Models.TaskLabel", b =>
                {
                    b.HasOne("FinanceApi.Features.Labels.Models.Label", "Label")
                        .WithMany("TaskLabels")
                        .HasForeignKey("LabelId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FinanceApi.Features.Tasks.Models.Task", "Task")
                        .WithMany("Labels")
