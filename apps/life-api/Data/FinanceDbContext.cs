...
using LifeApi.Features.Finance.Models;
...
using LifeApi.Features.Settings.Models;
...
public class FinanceDbContext : DbContext
{
    ...
    public DbSet<LifeApi.Features.Tasks.Models.Task> Tasks { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        // Task configuration
        modelBuilder.Entity<LifeApi.Features.Tasks.Models.Task>(entity =>
        {
