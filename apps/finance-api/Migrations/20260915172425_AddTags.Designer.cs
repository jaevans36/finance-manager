...
namespace FinanceApi.Migrations
{
    ...
    [Migration("20260915172425_AddTags")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FinanceApi.Features.Accounts.Models.AccountShare", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("account_shares", "finance");
                });

            modelBuilder.Entity("FinanceApi.Features.Alerts.Models.NotificationRun", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("NotificationRuns", "finance");
                });

            modelBuilder.Entity("FinanceApi.Features.Alerts.Models.RecurringPaymentBaseline", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<decimal>("LastAlertedAmount")
                        .HasPrecision(18, 4)
                        .HasColumnType("numeric(18,4)");
                    ...
                    b.HasIndex("UserId", "MerchantName", "AccountId")
                        .IsUnique();

                    b.ToTable("RecurringPaymentBaselines", "finance");
                });

            modelBuilder.Entity("FinanceApi.Features.Assets.Models.Asset", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("FinanceApi.Features.Common.ActivityLogs.Models.ActivityLog", b =>
                {
                    ...
                    b.ToTable("activity_logs", "finance");
                });

            modelBuilder.Entity("FinanceApi.Features.Common.Users.Models.LifeManagerUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("FinanceApi.Features.Tags.Models.Tag", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("Tags", "finance");
                });

            modelBuilder.Entity("FinanceApi.Features.Tags.Models.TransactionTag", b =>
                {
            ...
            modelBuilder.Entity("FinanceApi.Features.Tags.Models.TransactionTag", b =>
                {
                    b.HasOne("FinanceApi.Features.Tags.Models.Tag", "Tag")
                        .WithMany("TransactionTags")
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FinanceApi.Features.Transactions.Models.Transaction", "Transaction")
                        .WithMany("TransactionTags")
            ...
            modelBuilder.Entity("FinanceApi.Features.Transactions.Models.Transaction", b =>
                {
                    ...
                    b.HasOne("FinanceApi.Features.IncomeStreams.Models.IncomeStream", "IncomeStream")
                        .WithMany()
