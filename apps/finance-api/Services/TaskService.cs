...
public class TaskService : ITaskService
{
    ...
    public async System.Threading.Tasks.Task<TaskDto> CreateTaskAsync(Guid userId, CreateTaskRequest request)
    {
        ...
        await _activityLogService.LogAsync(userId, Models.ActivityType.TaskCreated, $"Created task: {task.Title}", null, null);
    ...
    public async System.Threading.Tasks.Task<TaskDto> UpdateTaskAsync(Guid userId, Guid taskId, UpdateTaskRequest request)
    {
        ...
        if (request.Completed.HasValue)
        {
            ...
            if (request.Completed.Value && !task.CompletedAt.HasValue)
            {
                ...
                await _activityLogService.LogAsync(userId, Models.ActivityType.TaskCompleted, $"Completed task: {task.Title}", null, null);
            }
        ...
        await _activityLogService.LogAsync(userId, Models.ActivityType.TaskUpdated, $"Updated task: {task.Title}", null, null);
    ...
    public async System.Threading.Tasks.Task DeleteTaskAsync(Guid userId, Guid taskId)
    {
        ...
        await _activityLogService.LogAsync(userId, Models.ActivityType.TaskDeleted, $"Deleted task: {task.Title}", null, null);
    }
