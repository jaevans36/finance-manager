...
using Moq;
using Xunit;
using LifeApi.Features.Statistics.Controllers;
using LifeApi.Features.Statistics.Services;
using LifeApi.Features.Statistics.DTOs;

namespace LifeApi.UnitTests.Features.Statistics;
...
public class StatisticsControllerTests
{
    ...
    public async Task GetWeeklyStatistics_EmptyWeek_ReturnsZeroStatistics()
    {
        ...
        var emptyStats = new WeeklyStatisticsDto
        {
            ...
            DailyBreakdown = new List<DailyStatisticsDto>
            {
                new DailyStatisticsDto { Date = weekStart, TotalTasks = 0, CompletedTasks = 0, CompletionRate = 0m, Tasks = new List<LifeApi.Features.Tasks.DTOs.TaskDto>() },
                new DailyStatisticsDto { Date = weekStart.AddDays(1), TotalTasks = 0, CompletedTasks = 0, CompletionRate = 0m, Tasks = new List<LifeApi.Features.Tasks.DTOs.TaskDto>() },
                new DailyStatisticsDto { Date = weekStart.AddDays(2), TotalTasks = 0, CompletedTasks = 0, CompletionRate = 0m, Tasks = new List<LifeApi.Features.Tasks.DTOs.TaskDto>() },
                new DailyStatisticsDto { Date = weekStart.AddDays(3), TotalTasks = 0, CompletedTasks = 0, CompletionRate = 0m, Tasks = new List<LifeApi.Features.Tasks.DTOs.TaskDto>() },
                new DailyStatisticsDto { Date = weekStart.AddDays(4), TotalTasks = 0, CompletedTasks = 0, CompletionRate = 0m, Tasks = new List<LifeApi.Features.Tasks.DTOs.TaskDto>() },
                new DailyStatisticsDto { Date = weekStart.AddDays(5), TotalTasks = 0, CompletedTasks = 0, CompletionRate = 0m, Tasks = new List<LifeApi.Features.Tasks.DTOs.TaskDto>() },
                new DailyStatisticsDto { Date = weekStart.AddDays(6), TotalTasks = 0, CompletedTasks = 0, CompletionRate = 0m, Tasks = new List<LifeApi.Features.Tasks.DTOs.TaskDto>() }
            }
        };
    ...
    public async Task GetDailyStatistics_WithValidDate_ReturnsOkWithStatistics()
    {
        ...
        var expectedStats = new DailyStatisticsDto
        {
            ...
            Tasks = new List<LifeApi.Features.Tasks.DTOs.TaskDto>()
        };
