...
## [0.16.0](https://github.com/jaevans36/finance-manager/compare/v0.15.0...v0.16.0) (2026-09-15)
...
* add automated VPS deploy pipeline ([#130](https://github.com/jaevans36/finance-manager/issues/130)) ([70e0cdc](https://github.com/jaevans36/finance-manager/commit/70e0cdc39877b238fd2d8947245262eadabd0d44))
...
* add free-form tags and wrap category rules as MCP tools ([#166](https://github.com/jaevans36/finance-manager/issues/166)) ([2cdf948](https://github.com/jaevans36/finance-manager/commit/2cdf9483ce92ca65d475cab02394775634159bcc))
...
* **auth:** change password from the profile screen ([#161](https://github.com/jaevans36/finance-manager/issues/161)) ([e80782d](https://github.com/jaevans36/finance-manager/commit/e80782db13ed4051fea98b37e2dc53b2ef866b25))
...
* **deploy:** deploy finance-api to the VPS, sharing life-api's database ([#151](https://github.com/jaevans36/finance-manager/issues/151)) ([1cd3ee9](https://github.com/jaevans36/finance-manager/commit/1cd3ee9496b1b460bbb318f57ecbc525c80ec627))
* **deploy:** manual approval gate on prod, optional dev auto-deploy ([#148](https://github.com/jaevans36/finance-manager/issues/148)) ([9f51e99](https://github.com/jaevans36/finance-manager/commit/9f51e9930342d309621a07613940c4dc6c8a677d))
...
* **dev:** containerize local dev stack, drop system-wide process kills ([#138](https://github.com/jaevans36/finance-manager/issues/138)) ([c2995d1](https://github.com/jaevans36/finance-manager/commit/c2995d17245650a36440c743da9904d153273397))
...
* Finance section — accounts, transactions, budgets, bills, debt burndown & affordability (Phases 41–47) ([#123](https://github.com/jaevans36/finance-manager/issues/123)) ([9f0fd5d](https://github.com/jaevans36/finance-manager/commit/9f0fd5d925fe1ef683aa8ee7b1f38d5ec4bcde39))
* **finance-api:** add an activity log, wire it into Account CRUD ([#153](https://github.com/jaevans36/finance-manager/issues/153)) ([6720286](https://github.com/jaevans36/finance-manager/commit/6720286671be1e7dcf918b7e1bc8df631e13c544))
* **finance-api:** add full read/write account sharing between Life Manager users ([#154](https://github.com/jaevans36/finance-manager/issues/154)) ([f6d7b34](https://github.com/jaevans36/finance-manager/commit/f6d7b34e72e7507e04a39eff378bdd8c1e1fcd07))
* **finance-api:** encrypt free-text columns at rest with AES-256-GCM ([#136](https://github.com/jaevans36/finance-manager/issues/136)) ([2b1a7db](https://github.com/jaevans36/finance-manager/commit/2b1a7db754d1ddc995e6df35391166c616adc22e))
* **finance-api:** thread activity-log audit logging through every write path ([#157](https://github.com/jaevans36/finance-manager/issues/157)) ([257c3f6](https://github.com/jaevans36/finance-manager/commit/257c3f6756c06031fe05e1bfb604bea63911d094))
* **finance:** add daily bill digest and price-change alerts via Discord ([#164](https://github.com/jaevans36/finance-manager/issues/164)) ([c6a0eaf](https://github.com/jaevans36/finance-manager/commit/c6a0eafa8695523aa3ad1955ae23021424e8a2d3))
* **finance:** add structured JSON transaction import ([#163](https://github.com/jaevans36/finance-manager/issues/163)) ([061c8ae](https://github.com/jaevans36/finance-manager/commit/061c8aebd6786be3362f4cf3af37b740f18ab2d7))
* **finance:** net worth history and tracked assets ([#159](https://github.com/jaevans36/finance-manager/issues/159)) ([a7fcbe2](https://github.com/jaevans36/finance-manager/commit/a7fcbe2d62d189ed8a0d7a808f9884f8a705f8cc))
...
* **mcp:** add finance-mcp core tools, slice 1 ([#155](https://github.com/jaevans36/finance-manager/issues/155)) ([2bf75ac](https://github.com/jaevans36/finance-manager/commit/2bf75acca3bf8f1ba63559a282f226cbc7503763))
* **mcp:** add finance-mcp reporting tools, slice 3 ([#162](https://github.com/jaevans36/finance-manager/issues/162)) ([27ecbd5](https://github.com/jaevans36/finance-manager/commit/27ecbd5315df88af9de8cef38dfa056af544be31))
* **mcp:** add finance-mcp statement ingestion, slice 2 ([#158](https://github.com/jaevans36/finance-manager/issues/158)) ([f4650a1](https://github.com/jaevans36/finance-manager/commit/f4650a1d1ba7dbc9bd38f4fd67de56038b6bd2b6))
* **mcp:** life-mcp events, labels & resources (T1622-T1649) ([#132](https://github.com/jaevans36/finance-manager/issues/132)) ([02a98bc](https://github.com/jaevans36/finance-manager/commit/02a98bc6ef920beaf97192f57ebac5deda7ea046))
* **mcp:** life-mcp foundation — tasks over MCP (T1596-T1621) ([#131](https://github.com/jaevans36/finance-manager/issues/131)) ([fe17544](https://github.com/jaevans36/finance-manager/commit/fe17544ffd513a5fb418d0a7596074841d8ad331))
* **mcp:** wrap Bills CRUD as MCP tools ([#168](https://github.com/jaevans36/finance-manager/issues/168)) ([96b9d3b](https://github.com/jaevans36/finance-manager/commit/96b9d3b928a779b79127290fcf357b4f5f0b13c9))
...
* **web:** add priority filter, priority-first sort, and hide-completed toggle to Tasks list ([#146](https://github.com/jaevans36/finance-manager/issues/146)) ([faa5509](https://github.com/jaevans36/finance-manager/commit/faa5509d7b38ba1275045a147569e9b990795253))
...
* **web:** cockpit theme redesign — palette, typography, and dense-row UX pass ([#142](https://github.com/jaevans36/finance-manager/issues/142)) ([634387e](https://github.com/jaevans36/finance-manager/commit/634387ecf809974706701b62c82d095be8ca46bb))
* **web:** declutter task detail header, make Group/Priority/Due date live-editable ([#145](https://github.com/jaevans36/finance-manager/issues/145)) ([8ac80d4](https://github.com/jaevans36/finance-manager/commit/8ac80d47d4ddf11d9b780aa28e80b78d2ae99bb0))
...
* wrap debt, assets, income streams, and net worth as MCP tools; tag transactions by income stream ([#165](https://github.com/jaevans36/finance-manager/issues/165)) ([91f5f17](https://github.com/jaevans36/finance-manager/commit/91f5f17b3af2777237962a1efedc5a9ff45988ea))
...
* **deploy:** correct finance-api's build context on the VPS ([#152](https://github.com/jaevans36/finance-manager/issues/152)) ([a5108a3](https://github.com/jaevans36/finance-manager/commit/a5108a34a31f71b72901a81973ef4076bead4db0))
...
* **finance-api:** make transactions sharing-aware, close an IDOR on writes ([#156](https://github.com/jaevans36/finance-manager/issues/156)) ([fbc0cbd](https://github.com/jaevans36/finance-manager/commit/fbc0cbda7fc54a42c57455bc70313825580d77c3))
* **finance:** stop relabelling a transaction as Transfer from silently doubling its balance impact ([#169](https://github.com/jaevans36/finance-manager/issues/169)) ([85326b2](https://github.com/jaevans36/finance-manager/commit/85326b2f99f375757208b32646fd444607daab82))
* **finance:** treat an overdrawn checking account as debt ([#167](https://github.com/jaevans36/finance-manager/issues/167)) ([ea5f0c8](https://github.com/jaevans36/finance-manager/commit/ea5f0c8c31103f4ecbce2060985b0710e8443dbf))
...
* **life-api:** exclude subtasks from a task group's task count ([#147](https://github.com/jaevans36/finance-manager/issues/147)) ([d9cd105](https://github.com/jaevans36/finance-manager/commit/d9cd105171e099e4ba821fea7479ccf20699e54e))
* **life-api:** populate Label navigation when attaching labels to a new task ([#139](https://github.com/jaevans36/finance-manager/issues/139)) ([d973cfb](https://github.com/jaevans36/finance-manager/commit/d973cfb28608e090cdb4de759049a3bf53db6168))
* **life-api:** thread client ip/user-agent into task & event audit logs ([#135](https://github.com/jaevans36/finance-manager/issues/135)) ([8705ac3](https://github.com/jaevans36/finance-manager/commit/8705ac35c36829343461479c88226e12daefaa1b))
...
* remove clock-boundary flakiness from statistics tests ([#128](https://github.com/jaevans36/finance-manager/issues/128)) ([763fb3e](https://github.com/jaevans36/finance-manager/commit/763fb3e876327844ca9bf87c1181740e91e56fee))
...
* **scripts:** resolve repo root instead of hardcoding it in verify/test scripts ([#160](https://github.com/jaevans36/finance-manager/issues/160)) ([d3a60aa](https://github.com/jaevans36/finance-manager/commit/d3a60aa701afd853e516e5d380ecf05d0d5f6325))
...
* **web:** make the subtask checkbox toggle completion, not bulk-select ([#149](https://github.com/jaevans36/finance-manager/issues/149)) ([d93671f](https://github.com/jaevans36/finance-manager/commit/d93671f024fc25206d60b861021a13edb36867ed))
...
* **web:** move Task Groups filter into a sticky sidebar ([#144](https://github.com/jaevans36/finance-manager/issues/144)) ([239db0f](https://github.com/jaevans36/finance-manager/commit/239db0f76d93245ecd263b9ce995512ab47682ec))
* **web:** pass VITE_FINANCE_API_URL through to the Vite build ([#170](https://github.com/jaevans36/finance-manager/issues/170)) ([9854f71](https://github.com/jaevans36/finance-manager/commit/9854f7112792080d5cdf223e9cfccdd23f7c28d9))
...
* **web:** stop Weekly Progress crashing on delegated/assigned-to-me stats ([#140](https://github.com/jaevans36/finance-manager/issues/140)) ([1b701b5](https://github.com/jaevans36/finance-manager/commit/1b701b54fd3a352a283b71177cb941261ba8e6b8))
* **web:** Tasks page usability pass — checkbox, badge clarity, layout density ([#143](https://github.com/jaevans36/finance-manager/issues/143)) ([411f2f6](https://github.com/jaevans36/finance-manager/commit/411f2f6b63ab6df4531494f92fcb8f779736dd20))
...
### Added
- **Daily finance alerts via Discord** (`docs/intent/2026-09-15-finance-alerts.md`) — finance-api's first scheduled/background job (neither API has ever had one before). A `FinanceAlertsBackgroundService` checks once a day whether any bills are due and whether a recurring payment/subscription's price has jumped, posting to a dedicated Discord webhook for anything worth surfacing. Price-change detection is a genuinely new piece of logic, not just a wrapper: `RecurringPaymentDetector`'s existing `AmountTrend` is a stateless windowed average recomputed every call (would stay "Increasing" for months after a single jump), so a new `RecurringPaymentBaseline` table tracks the last amount actually alerted on per user+merchant+account — a price is only alert-worthy when it differs from that baseline by more than a threshold (default 10%), and firing updates the baseline so the same jump can't re-fire tomorrow. Discord-only for v1 (no in-app bell integration — flagged as a follow-up). A `POST /api/v1/dev/alerts/run-now` endpoint (finance-api's first `Dev` feature, double-gated like life-api's) lets this be tested end-to-end without a 24-hour wait. 18 new backend tests, plus a live smoke test against the real dev database: seeded baselines for every real detected recurring pattern with no false alerts, then deliberately bumped a real transaction's amount by 12% and confirmed exactly one Discord-ready alert fired with the correct old/new amounts, the baseline updated, and a third run didn't re-alert for the same change.
- **Structured JSON transaction import** (`docs/intent/2026-09-15-finance-json-transaction-import.md`) — new `POST /api/v1/finance/transactions/import-json` and `finance_import_transactions_json` finance-mcp tool, alongside (not replacing) the existing CSV import path. Lets Claude hand over a batch of transactions with category/payee/notes already attached, rather than flattening everything into a 3-column generic CSV and losing that detail. Reuses `CsvImportService`'s exact dedup/insert/balance-update/bill-matching pipeline (refactored into a shared internal method) — same duplicate detection, same bill auto-matching, same activity log. New `ImportSource.JsonImport` value (appended, not inserted, so the existing string-serialised enum is undisturbed). 10 new backend unit tests, 5 new integration tests, 7 new finance-mcp tests — plus a live smoke test against the real dev database (category/payee/notes preserved exactly, balance updated correctly, dedup confirmed on re-import, test data cleaned up afterwards).
- **`finance-mcp` reporting tools, slice 3** (`docs/intent/2026-09-14-finance-mcp-reporting-tools.md`) — 8 new `finance_*` tools, each wrapping one already-tested finance-api endpoint: `finance_search_transactions` (find a specific transaction by description/payee), `finance_categorise_transaction`, `finance_get_recurring_payments` (subscriptions/recurring bills with amount-trend and possibly-inactive flags), `finance_update_pot_budget`, `finance_get_monthly_budget_summary` (totalled + per-category), `finance_get_income_summary` (totalled + per-stream), `finance_update_savings_goal`, and `finance_get_ai_insights`. No new finance-api endpoints — same "reuse what's already built and tested" discipline as slices 1 and 2. Deliberately still out of scope: the Phase 49 tools with no backend endpoint at all (financial health score, cashflow forecast, monthly report, tax year summary, compare months, export, transaction summary, bill history, bill-flag-for-review, pot transactions) — each needs a real finance-api design decision first, not something to invent unsupervised. 27 new tests, plus a live smoke test against the real dev database confirming every tool's actual request/response shape matches (including one real finding: finance-api's PATCH endpoints silently no-op on an explicit `null` for a nullable field rather than clearing it — same "only provided fields change" convention already used everywhere else in this codebase, just confirmed to apply here too).
- **Change password from the profile screen** — previously the only way to change a password was the "forgot password" email flow (or, in Development only, a direct-reset debug endpoint); a logged-in user had no way to change it deliberately. Profile now has an inline "Change" action next to the masked password field, matching the existing username-edit pattern. New `PATCH /api/v1/auth/me/password` (current + new password, current password verified via the existing `IPasswordHasher` before the hash is updated) returns `400` (not `401`) on an incorrect current password, so the frontend's global 401 interceptor doesn't force-log the caller out for a typo. Session rows for the account are cleared on a successful change (same pattern as the reset-password flow) — since JWTs aren't checked against the sessions table, this doesn't sign the caller out of their current session, only forces re-authentication anywhere else the account is signed in. New `changePasswordSchema` (`@life-manager/schema`) reuses the existing `passwordSchema` complexity rules. 6 new backend tests (3 unit, 3 integration — including a full login-with-old/login-with-new-password round trip) and 7 new frontend tests.
- **Finance — Net worth history and tracked assets** (`docs/intent/2026-09-14-net-worth-history.md`) — new "Net Worth" tab showing a 12-month trend chart alongside the existing point-in-time figure, plus a new `Assets` feature (property, vehicle, other) so a mortgage can finally be netted against the house it bought instead of showing as a large unexplained negative. History is reconstructed from transaction data rather than snapshotted on a schedule — `currentBalance − sum(transactions after that date, signed by type)` for each of the trailing 12 month-ends, reusing the exact sign convention `TransactionService` already applies to `Account.Balance` — so there's real history from day one with no new scheduled-job infrastructure. Deliberate scope line: only *account* balances are reconstructed for history; tracked assets have no historical value on record, so they're included in today's net-worth figure but not backdated on the chart — called out directly in the UI copy. New endpoints: `GET /api/v1/finance/accounts/net-worth-history?months=`, full `Assets` CRUD (`GET/POST /api/v1/finance/assets`, `PATCH/DELETE /api/v1/finance/assets/{id}`). `Asset.Name`/`Notes` are column-encrypted and activity-logged from creation, matching every feature built since ADR-022. 18 new backend tests (11 `AssetService`, 7 integration) plus 5 more on `AccountService`/`AccountsController` for the history reconstruction and asset-inclusive net worth; 13 new frontend tests (`AssetForm`, `NetWorthDashboard`). Also fixed two UI bugs found during a live check of this feature: the Finance tab bar now wraps onto a second line instead of showing an internal scrollbar once there are enough tabs to overflow, and the net-worth summary figure no longer line-breaks between the minus sign and the amount at narrow viewport widths (both `NetWorthDashboard` and the pre-existing `AccountsDashboard`).
- **`finance-mcp` statement ingestion, slice 2** (`docs/intent/2026-09-14-finance-mcp-statement-ingestion.md`) — 3 new `finance_*` tools on `@life-manager/mcp`: `finance_import_transactions` (imports a batch from CSV — either a real bank export, or a `generic`-format CSV Claude builds itself from a PDF statement it's read natively — via the same multipart endpoint the web app uses, so duplicate detection happens against the real database, not conversation memory), `finance_update_account` (balance updates and debt terms — interest rate, credit limit, promotional details, mortgage term — entered conversationally), and `finance_check_account_completeness` (flags which of those debt fields a credit/mortgage/loan account is still missing, since a debt projection run without them isn't a real projection). No new finance-api endpoints — all three reuse existing REST endpoints finance-mcp didn't expose yet. 18 new tests, including a direct (non-mocked) test of the CSV-import API function, since it's the only place in this package building a multipart request from Node's native `FormData`/`Blob`.
- **Finance — activity log now covers every write, not just accounts** — `ActivityLogService` shipped with account sharing but only `AccountService` actually called it; every other write path (transactions, bills, budgets, spending pots, savings goals, income streams, category rules, CSV import) was silent, so "who changed this bill" was unanswerable for anything except account edits. Threaded through all seven remaining services, mirroring `AccountService`'s exact pattern: real caller IP/user-agent from each controller, changed-field *names* only on update (never values — several of these have column-encrypted fields, and the same discipline is applied even to non-encrypted ones like `Transaction.Description` for consistency), no log entry when an update actually changes nothing, one entry for a bulk action (category-rule `apply-all`, budget `copy-from-previous`) rather than one per row it touched. 22 new tests proving each write path logs correctly and that update logs never leak field values. See `docs/intent/2026-09-14-finance-audit-log-expansion.md`.
- **Finance — account sharing** (`POST/DELETE /api/v1/finance/accounts/{id}/share*`, `GET .../shared-with-me`, `.../shared-by-me`, `.../share-invitations`) — an account owner can share full read/write access to an account with another Life Manager user (invite/accept/decline/revoke). A deliberate departure from `specs/applications/finance/tasks.md` Phase 50's original view-only design — Jay confirmed (2026-09-13) he wants full access from the start. `AccountShare` mirrors life-api's existing `EventShare` shape, minus the permission tiers. Recipient resolution reads life-api's `public.users` table directly (same physical Postgres instance, different schema — `LifeManagerUser`, explicitly excluded from finance-api's own migrations) rather than an inter-service HTTP call. Account deletion stays owner-only even for a fully-shared account — a deliberate line short of "full" access. Every `AccountService` read/write path now resolves visibility through `GetVisibleAccountIdsAsync` (owned + accepted-shared) instead of a raw `UserId` filter. 28 new tests (17 `AccountSharingService`, 5 more on `AccountService` proving shared-account visibility, 6 integration covering the full invite → accept → edit → revoke flow over real HTTP).
- **Finance — activity log** (`GET /api/v1/finance/activity-logs`) — records who changed what and when, mirroring life-api's existing `ActivityLog` pattern. Motivated by full read/write account sharing being planned next (`docs/intent/2026-09-13-finance-vps-migration-and-sharing.md`): once more than one user can write to the same data, "who did that" needs to be answerable. `AccountService` is the first caller (create/update/delete); other services follow in the sharing PR. Descriptions never embed the plaintext of an encrypted column — update logs record which field names changed, never the values. 11 new tests (7 service, 4 covering the logging behaviour itself).
- **Finance — column-level encryption at rest** — free-text fields that are never used in SQL search/sort/aggregation (`Account.Name`, `Institution`, `AccountNumberSuffix`, `Notes`; `Transaction.Notes`; `Bill.Name`, `Description`; `Budget.Title`, `Note`; `CategoryRule.Pattern`; `IncomeStream.Name`; `SavingsGoal.Name`; `SpendingPot.Name`) are now encrypted at rest with AES-256-GCM via an EF Core `ValueConverter`. Transaction amounts/balances and description/payee fields stay plaintext — both are load-bearing for SQL aggregation, free-text search, merchant grouping, and CSV-import dedup, and encrypting them would need those rewritten. Existing dev data migrated via a one-time `--backfill-encrypt-columns` startup tool (idempotent, `ENC1:`-prefixed values). Key from `Encryption:Key` config, no default in `docker-compose.yml` — fails fast if unset. See ADR-022.
- **MCP server (`@life-manager/mcp`, `apps/life-mcp/`)** — a stdio Model Context Protocol server that wraps `life-api` so Claude (CLI / Desktop) can read and manage Life Manager data without a browser. 14 tools: 7 task (`list_tasks`, `get_task`, `create_task`, `update_task`, `complete_task`, `delete_task`, `add_subtask`), 5 event (`list_events`, `get_event`, `create_event`, `update_event`, `delete_event`), 2 label (`list_labels`, `create_label`); 3 resources (`life-manager://tasks/today`, `.../tasks/overdue`, `.../events/upcoming`). Authenticates as the user's own `life-api` login (no service account — life-api has no cross-user scoping and no refresh token; JWT is cached in memory and re-obtained proactively before expiry and on any 401). Built multi-backend-ready so a future `finance-api` / `finance_*` namespace is a config bolt-on. Deferred: stats/user tools, the `stats/week` resource, and SSE transport. Phases 64–65 (partial). 109 Jest tests. See ADR-021 and `apps/life-mcp/README.md`.
- **`finance-mcp` core tools, slice 1** (`docs/intent/2026-09-13-finance-mcp-and-ingestion.md`) — 7 new `finance_*` tools on `@life-manager/mcp`: `finance_get_accounts`, `finance_get_transactions`, `finance_add_manual_transaction`, `finance_get_bills_due`, `finance_get_pot_balances`, `finance_get_savings_goals`, `finance_get_disposable_income`. Enabled by an optional `FIN_API_BASE_URL` env var — no separate credentials needed, since `finance-api` has no login of its own and validates the same JWT `life-api` issues (same `Jwt:Secret`), so the existing `life` backend's auth is reused via a new `createBackendWithSharedAuth()`. A tool whose backend isn't configured is now skipped at startup with a warning instead of crashing the server, since `finance` is optional. Deliberately out of scope for this slice (a follow-up, same two-slice pattern as the VPS migration): the remaining Phase 49 tools (transaction summary/search/categorise, bill history, pot contributions, budget/income summaries, savings goal updates, financial health score, AI insights, cashflow forecast, monthly report, tax year summary, compare months, export), and the CSV/PDF ingestion + cross-session duplicate detection work. Known gap carried over from `finance-api` itself: `finance_get_transactions` can't see transactions on an account shared with (not owned by) the caller, since `TransactionsController` isn't sharing-aware yet even though `AccountsController` is.
- **Tasks — reassign a task's group from the edit modal** — the task detail/edit modal previously had no way to change which task group a task belonged to after creation; the only route was recreating the task. Edit mode now shows a Group selector (populated from the caller's groups) preselected to the current group, on the Tasks and Calendar pages. The API (`PUT /api/v1/tasks/{id}` with `groupId`) already supported this — the gap was UI only.
...
- **Finance — Recurring payment detection is now scoped per account** — previously grouped purely by merchant name across *all* of a user's accounts, so the same merchant appearing on two accounts (e.g. a subscription moved between cards) would silently merge into one pattern with no way to tell which account it came from. Detection now groups by merchant *and* account, each detected pattern shows which account it was found on, and confirming a pattern as a bill pre-links it to that account automatically.
...
- **Finance — Income-account scoping UI** — `IncomeAccountIds`/`updateIncomeAccounts` already existed on the backend to limit income detection to specific accounts (so a partner's or shared account's deposits aren't misclassified as the user's income), but no UI ever called it. The Debt tab's income editor now lists all non-debt accounts as checkboxes, warns when detection is unscoped ("scanning all accounts"), and calls the existing endpoint on toggle.
- **Finance — Budget titles and notes** — Budgets can now optionally have a short title (shown instead of the bare category name, e.g. "Big shop" for Groceries) and a free-text note, alongside category and amount. `Budget` gains `Title`/`Note` fields.
- **Finance — Budget edit and delete** — the Budgets screen was previously add-only: once created, a budget couldn't be renamed, have its amount changed, or be removed, even though the backend `PUT`/`DELETE /api/v1/finance/budgets/{id}` endpoints already existed. The Budgets tab now has edit/delete icons per row (with a second-click delete confirmation, matching the Accounts tab), and an empty month offers "Copy last month's budgets" using the existing `copy-from-previous` endpoint.

### Fixed
- **Finance — transactions weren't sharing-aware, and had no ownership check on the write side at all** — `AccountsController` became sharing-aware in the account-sharing PR, but `TransactionsController` still filtered every read/write by `Transaction.UserId == callerId` (who created the row, not who can see the account), so a recipient who accepted a share could see the account but not a single transaction on it. Worse: `CreateTransactionAsync` and CSV import had no check at all that the caller owned or had been shared the target `AccountId` — any authenticated user who knew (or guessed) another user's account GUID could inject a transaction into it, silently mutating that account's balance. Every read/write path (`GetTransactions`, `GetTransactionById`, `CreateTransaction`, `UpdateTransaction`, `DeleteTransaction`, CSV import) now resolves access through `GetVisibleAccountIdsAsync` instead, matching `AccountService`'s existing pattern — full read/write for anyone the account is shared with, and a hard no for anyone it isn't, regardless of who technically created a given row. Deliberately not extended to Bills/Budgets/Pots — none of them are meaningfully account-scoped the way transactions are (see the intent doc for why). 17 new tests (12 unit, 5 integration over real HTTP) — 371 unit, 105 integration passing overall. See `docs/intent/2026-09-14-transaction-sharing-visibility.md`.
...
- **Finance — Manual income streams could be silently overridden by auto-detection** — once at least 2 months of credit transactions were detected (across whichever accounts income detection was scanning), the auto-detected total always won over manually-entered income streams, even when the user had explicitly set those up to correct a bad detection (e.g. a partner's salary landing on a joint account inflating the total). Manual income streams now always take priority once configured, rather than only being used as a low-confidence fallback when detection finds nothing.
